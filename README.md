...
Sou estudante de **Análise e Desenvolvimento de Sistemas** na UNINASSAU (com formação prevista para 12/2026). Tenho foco em **Desenvolvimento Back-end, Automação de Processos e Análise de Dados**.

Tenho fascínio por resolver problemas complexos por trás das telas, conectando sistemas, criando fluxos de automação eficientes e tratando dados estratégicos.

---

### 🚀 Sobre Mim & Diferenciais

* 🎓 **Formação:** Análise e Desenvolvimento de Sistemas — Maurício de Nassau (PB).
...
[![E-mail](https://img.shields.io/badge/E--mail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:SEU_EMAIL)
